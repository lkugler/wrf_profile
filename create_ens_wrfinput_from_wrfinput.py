...
def main(f_wrfinput_nature, f_wrfinput_ens, n_ens, number_of_random_numbers):
        ...
        for iens in range(n):
            ...
            r_ens[iens, mask_perturb] = r[mask_perturb] * perturb(0, 0.05, z_coarse, z[mask_perturb]) # 0.05
...
if __name__ == '__main__':
    ...
    Parameters:
    -----------
    f_wrfinput_nature : Path to nature run wrfinput file
    f_wrfinput_ens : Path to ensemble wrfinput file (<iens> will be replaced by the ensemble number)
    ...
    # ensemble wrfinputs
    f_wrfinput_ens = '/jetfs/home/lkugler/data/run_WRF/exp_nat250m_noDA/<iens>/wrfinput_d01'
    ...
    main(f_wrfinput_nature, f_wrfinput_ens, n_ens, number_of_random_numbers)